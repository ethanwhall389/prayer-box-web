        ...
        <div className="bg-slate-100 w-full p-4 flex flex-col items-start group hover:cursor-pointer rounded-lg">
            <form action="" className='w-full h-full flex flex-col gap-2'>
                <div className="flex w-full justify-between">
                    <input type="text" id='name' value={nameInput} onChange={(e) => setNameInput(e.target.value)} className='outline-none w-full text-lg font-bold'/>
                ...
                <textarea name="description" id="description" value={descriptionInput} onChange={(e) => setDescriptionInput(e.target.value)} className='p-2 w-full resize-none'></textarea>
                ...
                <button type='submit' onSubmit={handleSubmit} className='hidden'></button>
            </form>
        </div>
    )
}